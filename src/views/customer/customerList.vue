<template>
  <div style="margin-left: 5px">
    <div style="margin-top: 10px">
      <Screen v-permission="'CustomerListLook'" @query="query" />
    </div>
    <el-row style="float: left;margin: 0 20px 10px 0">
      <el-col :span="24">
        <div class="row-col">
          <el-button v-permission="'CustomerListReset'" type="primary" @click="rePwd()">重置密码</el-button>
          <el-button v-permission="'CustomerListEdit'" type="primary" @click="openUser">修改账号</el-button>
          <el-button v-permission="'CustomerListBill'" type="success">账单流水</el-button>
          <el-button v-permission="'CustomerListResetAdd'" type="primary" @click="isShowAdd">添加用户</el-button>
          <!-- -->
          <el-button v-permission="'CustomerListRecords'" type="primary" @click="pointsPage">积分记录</el-button>
        </div>
      </el-col>
    </el-row>
    <Dtable
